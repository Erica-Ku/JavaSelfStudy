...
public class HRSTest349 {
	int num;
	public static void calcTax(Employee e) {//Object e도 테스트
		e.calcSalary();
	...
	/*public static void calTax(Salesman s) {
		
	}
	public static void calTax(Consultant c) {
		
	}
	public static void calTax(Director d) {
